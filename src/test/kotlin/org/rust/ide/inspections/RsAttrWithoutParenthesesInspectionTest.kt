...
class RsAttrWithoutParenthesesInspectionTest : RsInspectionsTestBase(RsAttrWithoutParenthesesInspection::class) {
    ...
    fun `test fix repr without parentheses`() = checkFixByText(
        "Add parentheses to `repr`", """
    ...
    fun `test fix allow without parentheses`() = checkFixByText(
        "Add parentheses to `allow`", """
