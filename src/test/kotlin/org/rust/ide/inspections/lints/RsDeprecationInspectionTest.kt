...
class RsDeprecationInspectionTest : RsInspectionsTestBase(RsDeprecationInspection::class) {
    ...
    fun `test suppression quick fix for statement 1`() = expect<AssertionError> {
        checkFixByText(
            "Suppress `deprecated` for statement", """
            #[deprecated]
            pub fn foo() {}
    ...
    fun `test suppression quick fix for statement 2`() = checkFixByText(
        "Suppress `deprecated` for statement", """
        #[deprecated]
        pub struct Foo;
    ...
    fun `test suppression quick fix for field`() = checkFixByText(
        "Suppress `deprecated` for field x", """
        #[deprecated]
        pub struct Foo;
    ...
    fun `test suppression quick fix for struct`() = checkFixByText(
        "Suppress `deprecated` for struct Bar", """
        #[deprecated]
        pub struct Foo;
    ...
    fun `test suppression quick fix for fn`() = checkFixByText(
        "Suppress `deprecated` for fn main", """
        #[deprecated]
        pub fn foo() {}
    ...
    fun `test suppression quick fix for file`() = checkFixByText(
        "Suppress `deprecated` for file main.rs", """
        #[deprecated]
        pub fn foo() {}
