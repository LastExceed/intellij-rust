...
class RsLivenessInspectionTest : RsInspectionsTestBase(RsLivenessInspection::class) {
    ...
    fun `test no remove on struct field binding`() = checkFixIsUnavailable(
        "Remove", """
    ...
    fun `test no remove on tuple binding`() = checkFixIsUnavailable(
        "Remove", """
        fn foo() {
    ...
    fun `test remove empty variable`() = checkFixByText(
        "Remove variable `a`", """
        fn foo() {
    ...
    fun `test remove empty mut variable`() = checkFixByText(
        "Remove variable `a`", """
        fn foo() {
    ...
    fun `test remove empty ref variable`() = checkFixByText(
        "Remove variable `a`", """
        fn foo() {
    ...
    fun `test remove variable with a literal`() = checkFixByText(
        "Remove variable `a`", """
        fn foo() {
    ...
    fun `test remove variable with a unit type`() = checkFixByText(
        "Remove variable `a`", """
        fn foo() {
            let <warning>a/*caret*/</warning> = ();
        }
    ...
    fun `test remove variable with a path`() = checkFixByText(
        "Remove variable `a`", """
        struct S;
        fn foo() {
    ...
    fun `test remove variable with a nested expression without side effects`() = checkFixByText(
        "Remove variable `a`", """
        fn foo() {
            let b = &5;
    ...
    fun `test remove variable with a field access`() = checkFixByText(
        "Remove variable `a`", """
        struct S {
            a: u32
        }
    ...
    fun `test remove variable with a method call`() = checkFixByText(
        "Remove variable `a`", """
        struct S;
        impl S {
            fn bar(&self) {}
    ...
    fun `test remove variable with a function call`() = checkFixByText(
        "Remove variable `a`", """
        fn bar() -> u32 { 0 }
        fn foo() {
    ...
    fun `test remove variable with a block`() = checkFixByText(
        "Remove variable `a`", """
        fn foo() {
    ...
    fun `test no remove on struct literal parameter`() = checkFixIsUnavailable(
        "Remove", """
        struct S {
            a: u32
        }
    ...
    fun `test remove function lone parameter`() = checkFixByText(
        "Remove parameter `a`", """
    ...
    fun `test remove function parameter in the middle`() = checkFixByText(
        "Remove parameter `a`", """
    ...
    fun `test remove function lone argument`() = checkFixByText(
        "Remove parameter `a`", """
        fn foo(<warning>a/*caret*/</warning>: u32) {}
        fn bar() {
            foo(1);
    ...
    fun `test remove function argument trailing comma`() = checkFixByText(
        "Remove parameter `a`", """
        fn foo(<warning>a/*caret*/</warning>: u32,) {}
        fn bar() {
            foo(1,);
    ...
    fun `test remove function argument at the beginning`() = checkFixByText(
        "Remove parameter `a`", """
    ...
    fun `test remove function argument in the middle`() = checkFixByText(
        "Remove parameter `a`", """
        fn foo(_: u32, <warning>a/*caret*/</warning>: u32, _: i32) {}
        fn bar() {
            foo(1, 2, 3);
    ...
    fun `test remove function argument at the end`() = checkFixByText(
        "Remove parameter `a`", """
    ...
    fun `test remove function argument when function is used as an argument`() = checkFixByText(
        "Remove parameter `x`", """
    ...
    fun `test remove method argument UFCS`() = checkFixByText(
        "Remove parameter `a`", """
        struct S;
        impl S {
    ...
    fun `test remove method argument method call`() = checkFixByText(
        "Remove parameter `a`", """
        struct S;
        impl S {
            fn foo(&self, <warning>a/*caret*/</warning>: u32, _: u32) {}
